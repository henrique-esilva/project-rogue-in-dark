...
def blit_player(pyg, display, player):
    pyg.draw.rect(display, (34,78,5), pyg.Rect(player.position[0]*tamanho_dos_tiles[0], player.position[1]*tamanho_dos_tiles[1], tamanho_dos_tiles[0], tamanho_dos_tiles[1]), width=0)
